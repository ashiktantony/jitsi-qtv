...
/**
 * Implements a React {@link Component} which displays a button for video unmuting
 ...
 */
class DisableCamButton extends AbstractDisableCamButton {
    /**
...
export default translate(connect(_mapStateToProps)(DisableCamButton));
