...
import { UnMuteVideoRemoteParticipantsDialog } from '.';
 ...
 */
export default class AbstractUnMuteVideoButton extends AbstractButton<Props, *> {
    ...
    _handleClick() {
        ...
        dispatch(openDialog(UnMuteVideoRemoteParticipantsDialog, { participantID }));
    }
