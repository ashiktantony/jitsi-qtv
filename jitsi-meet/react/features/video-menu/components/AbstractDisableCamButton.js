...
import { DisableCamRemoteParticipantDialog } from ".";
 ...
 */
export default class AbstractDisableCamButton extends AbstractButton<Props, *> {
    ...
    _handleClick() {
        ...
        dispatch(
            openDialog(DisableCamRemoteParticipantDialog, { participantID })
        );
    }
